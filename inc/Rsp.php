...
class Rsp extends stdClass
{
    ...
    static function e500($msg = null)
    {
        return rsp(is_null($msg) ? 'Error interno': $msg);
    }
    ...
    static function false($msg = null, int $statusCode = 500)
    {
    ...
    static function okSaved($isEdit = false)
    {
        return self::ok($isEdit ? 'Actualizado correctamente' : 'Guardado correctamente');
    }
    ...
    static function items($items, $msg = null)
    {
        return self::ok($msg)->set('items', $items);
    }
